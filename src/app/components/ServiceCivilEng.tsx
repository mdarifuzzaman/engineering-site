...
const ServiceCivilEng = ({props}: any) => {
    console.log("ServiceCivilEng", props);
     return(
         <div className="services_section layout_padding">
         <div style={{position: "absolute", zIndex: "-1", width: "100%", height: "80%", backgroundImage: `url(${props?.globalDataSource?.fields?.BackgroundImageUrl?.value})`, "backgroundSize": "cover", "backgroundPosition": "center", "backgroundRepeat": "no-repeat", "opacity": "0.3"}}></div>          
 ...
 export default ServiceCivilEng;