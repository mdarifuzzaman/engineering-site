...
export default function HeroBanner({props}: any){
    ...
    return(
        <div className="banner_section layout_padding">
            <div style={{position: "absolute", zIndex: "-1", width: "100%", height: "80%", backgroundImage: `url(${props?.globalDataSource?.fields?.BackgroundImageUrl?.value})`, "backgroundSize": "cover", "backgroundPosition": "center", "backgroundRepeat": "no-repeat"}}></div>                    
