         ...
         <div className="container">
            <div className="row">
               <div className="col-md-12">
                  <h1 className="clients_taital">{props?.globalDataSource?.fields?.Title?.value}</h1>
               </div>
            </div>
            <div className="client_section_2">
               <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                  ...
                  <div className="carousel-inner">
                     {props?.globalDataSource?.fields?.ClientRemarks?.value && JSON.parse(props?.globalDataSource?.fields?.ClientRemarks?.value).map((remarks:any, index: number) => (
